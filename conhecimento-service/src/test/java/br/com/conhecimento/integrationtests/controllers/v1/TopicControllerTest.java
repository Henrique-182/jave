...
public class TopicControllerTest extends AbstractIntegrationTest {
	...
	void testCreate() throws JsonMappingException, JsonProcessingException {
		...
		assertTrue(content.contains("\"topicVOList\":{\"href\":\"http://localhost:8288/v1/topic?page=0&size=10&sortBy=name&direction=asc\"}"));
	}
	...
	void testHATEOAS() {
		...
		assertTrue(content.contains("\"self\":{\"href\":\"http://localhost:8288/v1/topic/15\"}"));
		assertTrue(content.contains("\"self\":{\"href\":\"http://localhost:8288/v1/topic/23\"}"));
		
		assertTrue(content.contains("\"first\":{\"href\":\"http://localhost:8288/v1/topic?page=0&size=10&sort=name,asc\"}"));
		assertTrue(content.contains("\"self\":{\"href\":\"http://localhost:8288/v1/topic?page=0&size=10&sort=name,asc\"}"));
		assertTrue(content.contains("\"next\":{\"href\":\"http://localhost:8288/v1/topic?page=1&size=10&sort=name,asc\"}"));
		assertTrue(content.contains("\"last\":{\"href\":\"http://localhost:8288/v1/topic?page=2&size=10&sort=name,asc\"}"));
