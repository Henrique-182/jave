...
public class KnowledgeControllerTest extends AbstractIntegrationTest {
	...
	void testCreate() throws JsonMappingException, JsonProcessingException {
		...
		assertTrue(content.contains("\"knowledgeVOList\":{\"href\":\"http://localhost:8288/v1/knowledge?page=0&size=10&sortBy=title&direction=asc\"}"));
	}
	...
	void testHATEOAS() {
		...
		assertTrue(content.contains("\"self\":{\"href\":\"http://localhost:8288/v1/knowledge/1\"}"));
		assertTrue(content.contains("\"self\":{\"href\":\"http://localhost:8288/v1/knowledge/2\"}"));
		
		assertTrue(content.contains("\"self\":{\"href\":\"http://localhost:8288/v1/knowledge?page=0&size=10&sort=title,asc\"}"));
