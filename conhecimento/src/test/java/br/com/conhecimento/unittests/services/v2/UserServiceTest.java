...
public class UserServiceTest {
	...
	void testFindById() {
		...
		assertTrue(persistedUser.getLinks().toString().contains("</v2/user?page=0&size=10&sortBy=username&direction=asc>;rel=\"userVOList\""));
	}
	...
	void testCreate() {
		...
		assertTrue(createdUser.getLinks().toString().contains("</v2/user?page=0&size=10&sortBy=username&direction=asc>;rel=\"userVOList\""));
	}
	...
	void testUpdateById() {
		...
		assertTrue(updatedUser.getLinks().toString().contains("</v2/user?page=0&size=10&sortBy=username&direction=asc>;rel=\"userVOList\""));
	}
